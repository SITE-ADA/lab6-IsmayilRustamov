...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponseDto createProduct(ProductRequestDto productDto) {
        ...
        product.setCategories(resolveCategories(productDto.getCategoryIds()));
    ...
    public ProductResponseDto updateProduct(UUID id, ProductRequestDto productDto) {
        ...
        existingProduct.setCategories(resolveCategories(productDto.getCategoryIds()));
    ...
    private HashSet<Category> resolveCategories(List<UUID> categoryIds) {
